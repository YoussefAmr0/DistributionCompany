        ...
        <div class="app-content">
            ...
            <div class="products-area-wrapper tableView">
                <div class="products-header">
                    <div class="product-cell price">Event<button class="sort-button">
                ...
                <div class="products-row">
                    ...
                    <div class="product-cell category">
                        <form method="POST" action="{{ route('texts.store') }}">
                            @csrf
                            <input type="text" name="content" placeholder="Enter event">
                    ...
                    <div class="product-cell action">
                        <form style="display: inline;" method="POST" action="{{ route('texts.destroy', $text->id) }}">
                            @csrf
                            @method('DELETE')
